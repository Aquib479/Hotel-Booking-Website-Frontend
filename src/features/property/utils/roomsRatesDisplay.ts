...
function buildRateOption(params: {
  ...
  return {
    ...
    payAtHotel: primaryRate?.payAtHotel ?? undefined,
    cardRequired: primaryRate?.cardRequired ?? undefined,
    specialRequestSupported: primaryRate?.specialRequestSupported ?? undefined,
    depositRequired: primaryRate?.depositRequired ?? undefined,
